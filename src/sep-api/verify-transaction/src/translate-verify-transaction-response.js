module.exports = function translateVerifyTransactionResponse
(
    {
        headers,
        jsonData
...
)
    {
        ...
        (
            ...
            {
                throw new Error('translateVerifyTransactionResponse must have headers.');
            }
        ...
        (
            ...
            {
                throw new Error('translateVerifyTransactionResponse must have jsonData.');
            }
        else if
        (
        ...
        (
        ...
        )
            {
                ...
                throw new Error(`translateVerifyTransactionResponse Error | ${sep_result_code} | ${sep_result_description}`)
            }
        else
            {
                throw new Error(`translateVerifyTransactionResponse Error | ${sep_result_code} | ${sep_result_description}`)
