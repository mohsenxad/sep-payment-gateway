...
(
...
)
    {
        ...
        (
            ...
            {
                throw new Error('buildMakeTransactionDetail must have TERMINAL_ID.');
            }
        ...
        (
        ...
        )
            {
                ...
                (
                    ...
                    {
                        throw new Error('makeTransactionDetail > TerminalNumber is not equal to setting TERMINAL_ID.');
                    }
